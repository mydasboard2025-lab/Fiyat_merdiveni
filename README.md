Bir tane sistem olsun oraya tüm araç fotolarını yükleyelim.
 
Bu fiyat merdiveni
İnput:
Fiyatlar, GP, İndirim koşulu
 
BMW X1 ve rakipteki araçların fiyat merdivenini hazırla verdiğim inputlara göre.
Fiyat konumları büyüklükleriyle orantılı yerleştirilsin. Doğru fotoğraflar kullanıldığına emin olunsun. 
...
if not available_codes:
    st.sidebar.warning(f"assets/images/{brand_folder} içinde PNG bulunamadı.")
